      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">
            Pemeriksaan{" "}
            <span className="bg-gradient-to-r from-cyan-400 to-green-400 bg-clip-text text-transparent">Nutrisi</span>
          </h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Isi formulir di bawah untuk menganalisis status nutrisi anak anda dan mendapatkan rekomendasi yang sesuai
          </p>
        </div>
        ...
        <Card className="max-w-4xl mx-auto bg-white shadow-xl">
          <CardHeader className="bg-gradient-to-r from-green-50 to-cyan-50 border-b">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold">Formulir Pemeriksaan Status Gizi</h2>
                <p className="text-gray-600 text-sm">
                  Lengkapi informasi berikut untuk mendapatkan analisis status gizi anak
                </p>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent className="p-8">
            <form className="space-y-8">
              ...
              {/* Data Antropometri */}
              <div>
                <h3 className="text-lg font-semibold mb-4">Data Antropometri</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="rendah">Rendah ({"<"} 2 juta)</SelectItem>
                        <SelectItem value="menengah">Menengah (2-5 juta)</SelectItem>
                        <SelectItem value="tinggi">Tinggi ({">"}5 juta)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
