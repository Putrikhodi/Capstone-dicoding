...
export const metadata: Metadata = {
  title: "NutriEdu",
  description: "NutriEdu hadir sebagai solusi untuk membantu orangtua mencegah dan mengatasi malnutrisi pada bayi dan balita usia 0-5 tahun",
  icons: [
    // Favicon standar
    { url: '/icon_16x16.png', sizes: '16x16', type: 'image/png' },
    { url: '/icon_32x32.png', sizes: '32x32', type: 'image/png' },
    // Apple Touch Icons
    { url: '/icon_180x180.png', sizes: '180x180', type: 'image/png', rel: 'apple-touch-icon' },
    // Android Chrome
