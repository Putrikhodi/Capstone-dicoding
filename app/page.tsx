    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i, index) => {
              let duration = baseDuration + index * 200;
                ...
                >
                  ...
                  <CardContent className="p-6">
                    <div className="text-sm text-gray-500 mb-2">
                      15 Mei 2024 • Oleh dr. Rina Putri
                    </div>
                    <h3 className="font-semibold mb-3">
                      Mengenal Tanda Stunting pada Bayi dan Balita
                    </h3>
                    <p className="text-gray-600 text-sm mb-4">
                      Stunting merupakan kondisi gagal tumbuh pada anak akibat
                      kekurangan gizi dalam waktu yang cukup lama. Ketahui
                      tanda-tandanya pada bayi dan balita.
                    </p>
                    <Button
                      variant="outline"
